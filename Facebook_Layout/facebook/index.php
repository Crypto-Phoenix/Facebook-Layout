...
<html>
	...
	<head>
		...
		<meta name="Description" content="Facebook style Homepage by using html and css" />
	</head>
	<body background=gal.JPG  leftmargin=100  right margin=100>
		...
		<div class="fb-body">
			...
			<div id="form3" class="fb-body">
				...
				<input placeholder="dd/mm/yyyy" type="date" id="namebox"  /><br><br>
		...
		<div class="fb-body-footer">
				...
				Sign Up	Log In	&copy; <a href="http://www.litindia.in">www.litindia.in</a> &nbsp;&nbsp; Design & Developed by LIT</div>
			</div>
	</body>
